            ...
            <div className="relative w-full max-w-[340px] bg-[#0b0c0e] border border-[#1e2025] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-[#1e2025]">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[12px] font-black text-[#e8eaed] uppercase tracking-widest">Update Security</span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-4">
                            <div className="relative">
                                <label className="block text-[9px] font-bold text-[#5a5f6e] uppercase tracking-widest mb-1.5 ml-1">Current Password</label>
                                <input
                                    type={showCurrent ? 'text' : 'password'}
                                    value={currentPassword}
                                    onChange={(e) => setCurrentPassword(e.target.value)}
                                    placeholder="••••••••"
                                    className="w-full px-4 py-2.5 bg-[#111214] border border-[#1e2025] rounded-xl text-white placeholder-[#222] text-[12px] focus:outline-none focus:border-[#00C853]/50 font-bold transition-all pr-10"
                                    required
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowCurrent(!showCurrent)}
                                    className="absolute right-3.5 top-[35px] text-[#3a3d45] hover:text-white transition-colors"
                                >
                            ...
                            <div className="relative">
                                <label className="block text-[9px] font-bold text-[#5a5f6e] uppercase tracking-widest mb-1.5 ml-1">New Password</label>
                                <input
                            ...
                            <div className="relative">
                                <label className="block text-[9px] font-bold text-[#5a5f6e] uppercase tracking-widest mb-1.5 ml-1">Confirm New Password</label>
                                <input
                        ...
                        <div className="p-3 bg-[#111214] rounded-xl border border-[#1e2025] space-y-1.5">
                            <p className="text-[9px] font-bold text-[#5a5f6e] uppercase tracking-widest mb-2">Password Strength</p>
                            {[
                                ...
                                <div key={i} className="flex items-center gap-2">
                                    ...
                                    <span className={`text-[9px] font-black uppercase tracking-tight ${rule.met ? 'text-[#e8eaed]' : 'text-[#3a3d45]'}`}>{rule.text}</span>
                                </div>
                            ))}
                        </div>

                        <div className="flex gap-2.5 p-3 bg-blue-500/5 border border-blue-500/10 rounded-xl">
                        ...
                        <div className="flex flex-col gap-3 pt-2">
                            <button
                                ...
                                className="w-full py-3.5 bg-[#00C853] hover:bg-[#00E676] disabled:opacity-30 text-black text-[11px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-green-500/10 flex items-center justify-center gap-2"
                            >
