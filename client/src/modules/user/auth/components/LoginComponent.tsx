    ...
    return (
        <div className="space-y-4">
            ...
            <button
                type="button"
                onClick={() => googleLogin()}
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-neutral-700/50 rounded-[5px] bg-[#121212] hover:bg-white hover:text-white transition-all duration-300 font-medium text-sm text-cool-white shadow-sm mt-4"
            >
