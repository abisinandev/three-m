...
import { SimulationTool } from '../components/ExpenseTracker/SimulationTool';
import { SimulationResultView } from '../components/ExpenseTracker/SimulationResult';
import type { SimulationResult } from '../types/expense-types';


import { formatCurrency } from '../helpers/expenseHelpers';
import { CHART_COLORS } from '../constants/expenseConstants';
import type { Category, TransactionType } from '../constants/ExpenseTrackerTypes';
