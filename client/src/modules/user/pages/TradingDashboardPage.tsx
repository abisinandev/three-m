...
const TradingDashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-inter pb-10">
      ...
      {/* Search Header - Since Navbar is in UserLayout, this provides a secondary local header if needed, but we can just integrate it into the content */}
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-[#1f1f1f]">
                  ...
                  {!isLoading && !isError && stocks.map((stock: any) => {
                    ...
                    return (
                      <tr key={stock.symbol} className="hover:bg-[#151515] transition-colors group cursor-pointer">
                        ...
                        <td className="px-5 py-4 text-right">
                          <div className="font-medium text-sm">₹{price.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</div>
                        </td>
                        <td className="px-5 py-4 text-right">
