            ...
            <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                <div className="w-full max-w-[360px] mx-auto border border-neutral-800/60 bg-neutral-900/30 rounded-xl p-6 shadow-sm">
                    ...
                    <button
                        type="button"
                        onClick={() => googleLogin()}
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-neutral-700/50 rounded-full bg-[#121212] hover:bg-white hover:text-black transition-all duration-300 font-medium text-sm text-cool-white shadow-sm mt-2"
                    >
