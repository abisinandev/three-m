...
import { ListFundUserSideUseCase } from "@application/use_cases/user/list-funds.usecase";
...
export const FeatureModule = new ContainerModule(({ bind }) => {
    ...
    bind<IMutualFundNavRepository>(FEATURE_TYPES.MutualFundNavRepsitory).to(MutualFundNavRepsitory);
    bind<IMutualFundNavRepository>(FEATURE_TYPES.MutualFundNavUpdate).to(MutualFundNavRepsitory);
    ...
    bind<IMutualFundNavUpdatesUseCase>(FEATURE_TYPES.MutualFundNavUpdate).to(MutualFundNavUpdate);
