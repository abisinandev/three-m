...
import { AgentService } from "@infrastructure/providers/ai-chatbot/agent.service";
...
import { EducationAgentService } from "@infrastructure/providers/ai-chatbot/education-agent.service";
import { IDetectAgent } from "@application/interfaces/services/ai-chatbot/detect-agent.service.interface";
import { DetectAgent } from "@infrastructure/providers/ai-chatbot/detect.agents";
